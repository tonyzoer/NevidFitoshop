	...
	<div id="fh5co-main">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 col-md-pull-8 simpleCart_shelfItem">

					<div class="fh5co-sidebox">
						<img width="100%" src="<?php echo "$imgsrc"; ?>" alt="Фото">
						<div class="item_imgsrc" hidden="hidden">	<?php echo "$imgsrc"; ?></div>
					</div>

					<div class="fh5co-sidebox">
						<h3 class="fh5co-sidebox-lead item_name"><?php echo "$name"; ?></h3>
						<p ><?php echo "$smalldesc"; ?></p>
					</div>

					<div class="fh5co-sidebox">
			<p> Ціна:	<a class='item_price' style='color:green;    bottom: 25px;left: 20px; font-size:2em' ><?php echo $price ; ?></a></p>

			<p>Кількість: <input class="form-control input-sm item_quantity" type="number" name="quantity" min="1" max="200" value="1"placeholder="Кількість"></p>

			<a href="javascript:;" class="btn btn-primary  item_add">Додати в Корзину</a>
